...
public:
	...
	BOOL Create(CWnd *pWndParent, LPCTSTR szText = NULL, DWORD dwTimeout = 1000, DWORD dwStyle = CSS_FADE|CSS_CENTERSCREEN|CSS_SHADOW) ;
...
public:
	...
	afx_msg void OnTimer(UINT_PTR nIDEvent) ; // for x64
	//afx_msg void OnTimer(UINT nIDEvent) ; // for x86
